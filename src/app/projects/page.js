...
const projects = [
  {
    ...
    description: `Drone Services involve the use of high-performance unmanned aerial vehicles (UAVs) equipped with specialized cameras, sensors, and navigation systems to carry out tasks in various domains such as aerial photography, surveillance, agriculture, inspection, and delivery. 
    These services are customized to meet the technical and operational needs of industries, institutions, and research organizations.

Our drone solutions include both off-the-shelf and custom-built drones, and we offer full deployment including pilot operation, flight planning, real-time data collection, post-processing, and system training.`,
  },
  {
    id: 2,
